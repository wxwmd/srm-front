  ...
  <div class="jz-supplier-container">
    ...
    <div class="jz-module-table">
      <el-table highlight-current-row
        ...
        <el-table-column prop="materialNumber" label="物料号" width="90px"/>
...
export default {
  ...
  created() {
    this.getRealName()
    this.tableUtil = new TableUtil(this.$api.supplier.material, {}, '物料')
  },
  methods: {
    selectedRow(row) {
    ...
    excelImport() {
      ...
      this.tableUtil.module.apis.importApi = this.$api.supplier.material.import
    ...
    templateExport() {
      this.tableUtil.form.currentApi = this.$api.supplier.material.templateExports
