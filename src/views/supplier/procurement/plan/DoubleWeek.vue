  ...
  <div class="jz-supplier-container">
    ...
    <div class="jz-module-table">
      <el-table highlight-current-row
        ...
        <el-table-column prop="supplierCode" v-if="this.$store.state.user.type !== 1" label="供应商编码"/>
...
export default {
  ...
  created() {
    this.tableUtil = new TableUtil(this.$api.supplier.procurement.plan.doubleWeek, {}, '双周供需核查表');
  },
  methods: {
