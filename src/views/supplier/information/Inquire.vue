  ...
  <div class="jz-supplier-container">
    ...
    <div class="jz-module-table">
      <el-table highlight-current-row
        ...
        <el-table-column prop="senderReadStatus" :formatter="formatInfoStatus" label="发件人状态" width="90px"/>
        <el-table-column prop="recipientReadStatus" :formatter="formatInfoStatus" label="收件人状态" width="90px"/>
...
export default {
  ...
  methods: {
    ...
    formatInfoStatus(row, column, cellValue) {
      let dictLabel = "";
