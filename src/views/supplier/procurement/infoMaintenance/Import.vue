  ...
  <div class="jz-supplier-container">
    ...
    <div class="jz-module-table">
      <el-table highlight-current-row
        ...
        <el-table-column prop="hostFactoryInventory" label="主机厂库存" width="110"/>
        <el-table-column prop="notTruckLoadingTotal" label="未装车订单合计" width="110"/>
...
export default {
  ...
  created () {
    this.tableUtil = new TableUtil(this.$api.supplier.procurement.infoMaintenance.import, {}, '供应商库存导入');
  ...
  methods:{
    ...
    exportData(){
      this.tableUtil.form.currentApi = this.$api.supplier.procurement.infoMaintenance.import.export
      this.tableUtil.export()
    },
    // 导入excel文件
    controlImportCamera() {
      this.tableUtil.upload.uploadName = 'file'
      this.tableUtil.module.apis.importApi = this.$api.supplier.procurement.infoMaintenance.import.import
